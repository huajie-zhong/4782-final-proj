...
export default function ArchitectureSection() {
  ...
  return (
    <section id="section-1" className="min-h-screen flex flex-col justify-center bg-white border-t border-birch">
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center text-sm max-w-3xl mx-auto w-full">
            {[
              ...
              <div key={label} className="bg-white border border-birch rounded p-4">
                <div className="text-xl md:text-2xl font-bold text-grove font-mono">{value}</div>
