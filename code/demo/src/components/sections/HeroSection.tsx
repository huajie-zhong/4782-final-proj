...
export default function HeroSection() {
  ...
  return (
    <section id="section-0" className="min-h-screen flex flex-col justify-center px-8 py-20 max-w-5xl mx-auto">
      <motion.div
      ...
      >
        <motion.div variants={fadeUp} className="text-center">
          <div className="font-mono text-xs text-grove border-b border-grove pb-0.5 mb-5 inline-block tracking-widest uppercase">
