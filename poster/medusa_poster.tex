...
\textbf{Future work.}
\begin{itemize}[leftmargin=*, topsep=0.3ex, itemsep=0.3ex]
...
\begin{minipage}{0.48\linewidth}
  \centering
  \includegraphics[width=0.7\linewidth]{assets/github_qr.png}\\
  {\scriptsize \textbf{Code}}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
  \centering
  \includegraphics[width=0.7\linewidth]{assets/medusa_demo_qr.png}\\
  {\scriptsize \textbf{Demo}}
\end{minipage}
\end{tcolorbox}
